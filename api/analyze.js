...
Precos de referencia desta familia (recibos reais de 2026 — ajusta com o teu conhecimento de precos atuais):
LIDL: atum natural 120g=0,79€, arroz agulha familiar=2,15€, queijo flamengo fatiado=3,99€, lombos pescada MSC=9,69€, gelado Double Bilionario=3,49€, gelado Space Runners=2,69€, mistura legumes chinesa=0,99€, mistura mexicana=2,99€, espinafres=1,15€, mirtilos 500g=6,59€, iogurte grego natural=1,75€, iogurte proteina pack8=3,29€, natas culinaria 200ml=0,79€, salmao posta=17,99€/kg, mel floral=5,29€, rolo cozinha 2 folhas=0,79€
...
Usa o campo "promo" apenas para promocoes que conheças (Lidl Plus, Poupa Mais, etc).
